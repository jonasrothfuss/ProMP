...
EXP_NAME = 'vpg-formulation-comparison'
...
if __name__ == '__main__':    
    ...
    sweep_params = {
        ...
        'experiment_tuple': [('MAML', 'log_likelihood', False), ('E-MAML', 'log_likelihood', True),
                             ('LVC', 'likelihood_ratio', False)],  # (name, inner_type, exploration)
