...
if __name__=="__main__":
    ...
    logger.configure(dir=maml_zoo_path + '/data/e_trpo/test_%d' % idx, format_strs=['stdout', 'log', 'csv'],
                     snapshot_mode='last_gap')
    config = json.load(open(maml_zoo_path + "/configs/e_trpo_maml_config.json", 'r'))
    json.dump(config, open(maml_zoo_path + '/data/e_trpo/test_%d/params.json' % idx, 'w'))
    main(config)
